    ...
    bg-opacity-0">
       <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <GenderCheckBox onCheckBoxChange = {handleCheckboxChange} selectedGeneder={inputs.gender}/>
                <Link to={'/login'} className='text-sm hover:underline hover:text-blue-600 mt-2 inline-block text-pink-200'>
